...
/// 设置结束的通知，用于更新界面
FOUNDATION_EXTERN NSString *const kYWMessageSettingCompletionNotification;
/// 设置结束的通知中，使用这个key传递personSettingArray
FOUNDATION_EXTERN NSString *const kYWMessageSettingCompletionNotificationKeyPersons;
/// 设置结束的通知中，使用这个key传递tribeSettingArray
FOUNDATION_EXTERN NSString *const kYWMessageSettingCompletionNotificationKeyTribes;
/// 设置结束的通知中，使用这个key传递NSError *
FOUNDATION_EXTERN NSString *const kYWMessageSettingCompletionNotificationKeyError;
