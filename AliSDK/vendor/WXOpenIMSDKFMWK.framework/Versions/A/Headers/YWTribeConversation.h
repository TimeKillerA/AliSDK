 ...
 *  @消息未读数
 */
@property (nonatomic, readonly) NSNumber *unreadAtMessagesCount;

/**
 *  @all消息未读数
 */
@property (nonatomic, readonly) NSNumber *unreadAtAllMessagesCount;
...
/**
 *  判断是否普通消息体，即图片、文本、语音等，非自定义也非系统消息
 */
- (BOOL)isNormalMessageBody;
