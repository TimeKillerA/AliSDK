...
/// YWAPI的模块Context名称，注册到这个名称下的模块会被加载到YWAPI中，这些模块都会在SyncInit或者AsyncInit后才会被调用
#define YWAPIContextName    YWAPI
...
/**
 *  是否正在语音或视频聊天，sdk将不会改变audioSession
 */
@property (nonatomic, assign) BOOL isVoiceChating;
 ...
 *  日志开关
 */
@property (nonatomic, assign) BOOL logEnabled __attribute__((deprecated("请使用`IYWLogService.h`中设置日志级别的接口")));
