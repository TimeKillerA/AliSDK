...
/// 判断是否为另一个 person 的子账号
- (BOOL)isSubAccountOfPerson:(YWPerson *)person;
...
@interface YWProfileItem (IYWEhelperService)

- (instancetype)profileItemForSubAccount:(YWPerson *)subAccountPerson;
