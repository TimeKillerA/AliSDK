 ...
 */
typedef void(^YWActionHandlerBlockYw)(NSString *aEvent, NSDictionary *aParams, YWActionHandlerResultBlock aResultBlock);
 ...
 *  添加Yw后缀以避免审核时私有api问题
 */
- (YWActionHandlerBlockYw)actionHandlerBlockYw;
 ...
 */
- (BOOL)callActionWithActionString:(NSString *)aActionString
                  additionalParams:(NSDictionary *)aAdditionalParams
                handlerResultBlock:(YWActionHandlerResultBlock)aHandlerResultBlock;

- (BOOL)callActionWithActionString:(NSString *)aActionString baseContext:(YWIMCore *)aImcore
                  additionalParams:(NSDictionary *)aAdditionalParams
                handlerResultBlock:(YWActionHandlerResultBlock)aHandlerResultBlock;
