...
#define TMKTemplateBackGroundLeft       @"bgl"
#define TMKTemplateBackGroundRight      @"bgr"
#define TMKTemplateBackGroundCenter     @"bgc"
#define TMKTemplateDisplayWidthScale    @"wd"

#define TMKTemplateDrawablePrefix       @"drawable://"
