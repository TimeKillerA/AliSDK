...
/// LoginId变更通知
FOUNDATION_EXTERN NSString * __nonnull const kYWLoginIdChangedNotification;
FOUNDATION_EXTERN NSString * __nonnull const kYWLoginIdChangedNotificationKeyIMCore;
